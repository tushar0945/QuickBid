...
//       <h2 className="text-xl font-semibold mb-4 ml-4">You might also like</h2>

//       {/* Left Button */}
//       <button
//         className="absolute left-2 top-1/2 transform -translate-y-1/2 bg-white shadow p-2 rounded-full z-10"
//         onClick={() => scroll("left")}
//       >
//         <FaChevronLeft />
//       </button>
...
//       <div
//         ref={scrollRef}
//         className="flex overflow-x-auto no-scrollbar space-x-4 px-10 scrollbar-hide"
//       >
...
//       {/* Right Button */}
//       <button
//         className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-white shadow p-2 rounded-full z-10"
