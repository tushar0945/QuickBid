...
//   const activeClasses =
//     "bg-gradient-to-r from-green-500 to-green-300 text-white font-semibold";
//   const inactiveClasses =
//     "text-gray-700 hover:bg-gradient-to-r from-green-500 to-green-300 hover:text-white";

//   return (
//     <div className="bg-white shadow h-screen lg:w-64 w-20 p-4 flex flex-col items-center lg:items-start sticky top-0 z-10">
//       {/* Logo / Title */}
//       <h2 className="text-xl font-bold mb-4 text-green-700 hidden lg:block">
//         SELLER
//       </h2>
