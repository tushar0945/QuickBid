...
//   const inputClass =
//     "w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-400 focus:outline-none transition";

//   return (
//     <div className="max-w-5xl mx-auto p-8 bg-white shadow-2xl rounded-2xl my-16">
...
//             } text-white text-lg font-semibold py-3 px-8 rounded-xl shadow-lg transition`}
//           >
...
export default function AddItemForm() {
  ...
  //     calculatedEnd.setDate(start.getDate() + parseInt(duration));
  //     setEndDate(calculatedEnd.toISOString().slice(0, 10)); // format YYYY-MM-DD
  //   }
  // }, [startDate, duration]);
